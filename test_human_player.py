...
def test_init_human_player_tictactoe():
    board = Board(1, 1)
    hp = HumanPlayerTicTacToe(Party.BLACK, board, "Edgar Wasser")
...
def test_init_human_player_tictactoe_no_name():
    board = Board(1, 1)
    hp_nameless = HumanPlayerTicTacToe(Party.WHITE, board)
...
def test_human_player_tictactoe_parse_keyboard_input_to_move():
    board = Board(1, 1)
    hp = HumanPlayerTicTacToe(Party.WHITE, board, "Parserino")
